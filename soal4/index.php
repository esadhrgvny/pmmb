  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <section class="social bg-light" id="graph">
      <div class="container">
        ...
        <form class="form-inline" style="margin: 10px;" id="searchbox">
    <input class="form-control" type="search" placeholder="Search by Nama, No Badge, atau Nama Anggota Keluarga" aria-label="Search" size="128" >
          ...
          <div class="card" style="width: 21rem;">
            <div class="card-body">
              <h5 class="card-title"><?php 
               echo $emp['EMP'][0]['NAMA'];
               ?>  </h5>
              <h6 class="card-subtitle mb-2 text-muted"><?= $emp['EMP'][0]['NO_BADGE'];
               ?>  </h6>
              <p class="card-text text-primary"><?= $emp['EMP'][0]['UNIT_KERJA']; ?></p>
            </div>
          </div>
          </div>
          ...
          <div class="col-md mb-4">
            <div class="card" style="width: 21rem;">
              <div class="card-body">
               ...
               echo $emp['EMP'][1]['NAMA'];
               ?>  </h5>
                <h6 class="card-subtitle mb-2 text-muted"><?= $emp['EMP'][1]['NO_BADGE'];
               ?>  </h6>
                  <p class="card-text text-primary"><?= $emp['EMP'][1]['UNIT_KERJA']; ?></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md mb-4">
            <div class="card" style="width: 21rem;">
              <div class="card-body">
               ...
               echo $emp['EMP'][2]['NAMA'];
               ?>  </h5>
                <h6 class="card-subtitle mb-2 text-muted"><?= $emp['EMP'][2]['NO_BADGE'];
               ?>  </h6>
                <p class="card-text text-primary"><?= $emp['EMP'][2]['UNIT_KERJA']; ?></p>
              </div>
            </div>
          </div>   
        </div>
          ...
          <div class="card" style="width: 21rem;">
            <div class="card-body">
              <h5 class="card-title"><?php 
               echo $emp['EMP'][3]['NAMA'];
               ?>  </h5>
              <h6 class="card-subtitle mb-2 text-muted"><?= $emp['EMP'][3]['NO_BADGE'];
               ?>  </h6>
              <p class="card-text text-primary"><?= $emp['EMP'][3]['UNIT_KERJA']; ?></p>
            </div>
          </div>
          </div>
          ...
          <div class="col-md mb-4">
            <div class="card" style="width: 21rem;">
              <div class="card-body">
               ...
               echo $emp['EMP'][4]['NAMA'];
               ?>  </h5>
                <h6 class="card-subtitle mb-2 text-muted"><?= $emp['EMP'][4]['NO_BADGE'];
               ?>  </h6>
                  <p class="card-text text-primary"><?= $emp['EMP'][4]['UNIT_KERJA']; ?></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md mb-4">
            <div class="card" style="width: 21rem;">
              <div class="card-body">
               ...
               echo $emp['EMP'][5]['NAMA'];
               ?>  </h5>
                <h6 class="card-subtitle mb-2 text-muted"><?= $emp['EMP'][5]['NO_BADGE'];
               ?>  </h6>
                <p class="card-text text-primary"><?= $emp['EMP'][5]['UNIT_KERJA']; ?></p>
              </div>
            </div>
          </div>   
        </div>
